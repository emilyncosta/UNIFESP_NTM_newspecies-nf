process CHECKM_LINEAGEWF {
    ...
    conda "bioconda::checkm-genome=1.1.8"
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/checkm-genome:1.1.8--pyhdfd78af_0' :
        'biocontainers/checkm-genome:1.1.8--pyhdfd78af_0' }"
